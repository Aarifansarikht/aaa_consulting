      ...
      <section>
        <div className={Style.Container}>
          <div className={Style.TextContent}>
            ...
            <p>
              Your data is your most valuable asset — holding real potential to
              revolutionize what your business can achieve. But without a modern
              solution to unify, process and deliver your analytics, you risk
              missing out on key information to innovate, adapt and grow.
            </p>
            <p>
              We’ll assess your current data landscape, modernize existing
              solutions and identify high-value opportunities to use data and AI
              in your organization to consistently deliver success. Through a
              defined strategy and end-to-end capabilities, we establish the
